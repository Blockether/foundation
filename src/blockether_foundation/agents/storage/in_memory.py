...
class InMemoryDb(BaseDb):
    ...
    # async method
    @override
    def table_exists(self, table_name: str) -> bool:  # public-api
        """In-memory implementation, always returns True."""
        return True

    async def atable_exists(self, table_name: str) -> bool:  # public-api
        """Async version of table_exists, always returns True."""
        return True

    # async method
    @override
    def get_latest_schema_version(self, table_name: str) -> str | None:  # public-api
        """Get the latest version of the database schema."""
        pass

    # async method
    @override
    def upsert_schema_version(self, table_name: str, version: str) -> None:  # public-api
    ...
    # async method
    @override
    def delete_session(self, session_id: str) -> bool:  # public-api
    ...
    # async method
    @override
    def delete_sessions(self, session_ids: list[str]) -> None:  # public-api
    ...
    # async method
    @override
    def get_session(  # public-api
        self,
        session_id: str,
        session_type: SessionType,
        user_id: str | None = None,
        deserialize: bool | None = True,
    ) -> AgentSession | TeamSession | WorkflowSession | dict[str, Any] | None:
    ...
    def get_sessions(  # public-api
        ...
        deserialize: bool | None = True,
    ) -> list[Session] | tuple[list[dict[str, Any]], int]:
            ...
            for session_data in self._sessions:
                ...
                if component_id is not None:
                    if (
                        ...
                        and session_data.get("agent_id") != component_id
                    ):
                        continue
                    elif (
                ...
                if (
                    ...
                    and session_data.get("created_at", 0) < start_timestamp
                ):
                    continue
        ...
        try:
            for i, session in enumerate(self._sessions):
                if (
                    ...
                    and session.get("session_type") == session_type.value
                ):
    ...
    def upsert_session(  # public-api
        ...
        try:
            ...
            for i, existing_session in enumerate(self._sessions):
                if existing_session.get("session_id") == session_dict.get(
                    "session_id"
    ...
    def _matches_session_key(
        self, existing_session: dict[str, Any], session: Session
    ) -> bool:  # public-api
    ...
    # async method
    @override
    def upsert_sessions(  # public-api
        self,
        ...
        try:
            log_info(
                f"In-memory database: processing {len(sessions)} sessions with individual upsert operations"
            )

            results: list[Session | dict[str, Any]] = []
    ...
    # async method
    @override
    def delete_user_memory(self, memory_id: str, user_id: str | None = None):  # public-api
    ...
    # async method
    @override
    def get_all_memory_topics(self, user_id: str | None = None) -> list[str]:  # public-api
        ...
        try:
            ...
            for memory in self._memories:
                ...
                if isinstance(memory_topics, list):
                    topics.update(memory_topics)  # type: ignore[arg-type]
            return list(topics)
    ...
    # async method
    @override
    def get_user_memory(  # public-api
        self, memory_id: str, deserialize: bool | None = True, user_id: str | None = None
    ...
    # async method
    @override
    def get_user_memories(  # public-api
        self,
        user_id: str | None = None,
    ...
    # async method
    @override
    def get_user_memory_stats(  # public-api
        self, limit: int | None = None, page: int | None = None, user_id: str | None = None
        ...
        try:
            ...
            stats_list: list[dict[str, Any]] = list(user_stats.values())
    ...
    # async method
    @override
    def upsert_user_memory(  # public-api
    ...
    # async method
    @override
    def upsert_memories(  # public-api
        self,
        memories: list[UserMemory],
        deserialize: bool | None = True,
        preserve_updated_at: bool = False,
    ) -> list[UserMemory | dict[str, Any]]:
        """
        ...
        try:
            log_info(
                f"In-memory database: processing {len(memories)} memories with individual upsert operations"
            )
            ...
            results: list[UserMemory | dict[str, Any]] = []
    ...
    # async method
    @override
    def clear_memories(self) -> None:  # public-api
        """Delete all memories.
    ...
    # async method
    @override
    def calculate_metrics(self) -> list[dict[str, Any]] | None:  # public-api
        ...
        try:
            ...
            start_timestamp = int(
                datetime.combine(dates_to_process[0], datetime.min.time()).timestamp()
            )
            end_timestamp = int(
                datetime.combine(
    ...
    def _get_metrics_calculation_starting_date(  # public-api
        ...
        if self._sessions:
            ...
            return datetime.fromtimestamp(first_session_date, tz=UTC).date()

        return None

    def _get_all_sessions_for_metrics_calculation(  # public-api
    ...
    # async method
    @override
    def delete_knowledge_content(self, id: str):  # public-api
    ...
    # async method
    @override
    def get_knowledge_content(self, id: str) -> KnowledgeRow | None:  # public-api
    ...
    # async method
    @override
    def get_knowledge_contents(  # public-api
        self,
        limit: int | None = None,
        page: int | None = None,
        sort_by: str | None = None,
    ...
    # async method
    @override
    def upsert_knowledge_content(self, knowledge_row: KnowledgeRow):  # public-api
    ...
    # async method
    @override
    def create_eval_run(self, eval_run: EvalRunRecord) -> EvalRunRecord | None:  # public-api
    ...
    # async method
    @override
    def delete_eval_runs(self, eval_run_ids: list[str]) -> None:  # public-api
        """Delete multiple eval runs from in-memory storage."""
        try:
            original_count = len(self._eval_runs)
            self._eval_runs = [
                run for run in self._eval_runs if run.get("run_id") not in eval_run_ids
            ]
    ...
    # async method
    @override
    def get_eval_run(  # public-api
        self, eval_run_id: str, deserialize: bool | None = True
    ) -> EvalRunRecord | dict[str, Any] | None:
    ...
    def get_eval_runs(  # public-api
        ...
        filter_type: EvalFilterType | None = None,
        eval_type: list[EvalType] | None = None,
        deserialize: bool | None = True,
            ...
            for run_data in self._eval_runs:
                ...
                if filter_type is not None:
                    if filter_type == EvalFilterType.AGENT and run_data.get("agent_id") is None:
                        ...
                        filter_type == EvalFilterType.WORKFLOW
                        and run_data.get("workflow_id") is None
                    ):
                        continue
    ...
    # async method
    @override
    def rename_eval_run(  # public-api
        self, eval_run_id: str, name: str, deserialize: bool | None = True
    ) -> EvalRunRecord | dict[str, Any] | None:
        """Rename an eval run."""
        try:
    ...
    # async method
    @override
    def clear_cultural_knowledge(self) -> None:  # public-api
    ...
    # async method
    @override
    def delete_cultural_knowledge(self, id: str) -> None:  # public-api
    ...
    # async method
    @override
    def get_cultural_knowledge(  # public-api
        self, id: str
    ...
    # async method
    @override
    def get_all_cultural_knowledge(  # public-api
        self,
        name: str | None = None,
        limit: int | None = None,
        page: int | None = None,
    ...
    # async method
    @override
    def upsert_cultural_knowledge(  # public-api
        ...
        try:
            ...
            return self.get_cultural_knowledge(cultural_knowledge.id)
        except Exception as e:
    ...
    # async method
    async def adelete_sessions(self, session_ids: list[str]) -> None:  # public-api
        """Async version of delete_sessions."""
        self.delete_sessions(session_ids)

    # async method
    async def aget_session(  # public-api
        self,
        session_id: str,
        session_type: SessionType,
        user_id: str | None = None,
        ...
        return self.get_session(session_id, session_type, user_id, deserialize)

    # async method
    async def aget_sessions(  # public-api
        self,
        session_type: SessionType,
        user_id: str | None = None,
        component_id: str | None = None,
    ...
    # async method
    async def arename_session(  # public-api
        self,
        session_id: str,
        session_type: SessionType,
        session_name: str,
        ...
        """Async version of rename_session."""
        return self.rename_session(session_id, session_type, session_name, deserialize)

    # async method
    async def aupsert_session(  # public-api
        self, session: Session, deserialize: bool | None = True
    ) -> Session | dict[str, Any] | None:
        """Async version of upsert_session."""
        return self.upsert_session(session, deserialize)

    # async method
    async def aupsert_sessions(  # public-api
        self,
        sessions: list[Session],
        deserialize: bool | None = True,
        preserve_updated_at: bool = False,
    ) -> list[Session | dict[str, Any]]:
        """Async version of upsert_sessions."""
        return self.upsert_sessions(sessions, deserialize, preserve_updated_at)

    # -- Async Memory methods --
    # async method
    async def adelete_user_memory(self, memory_id: str, user_id: str | None = None):  # public-api
        """Async version of delete_user_memory."""
        self.delete_user_memory(memory_id, user_id)

    # async method
    async def adelete_user_memories(
        self, memory_ids: list[str], user_id: str | None = None
    ) -> None:  # public-api
        """Async version of delete_user_memories."""
        self.delete_user_memories(memory_ids, user_id)

    # async method
    async def aget_all_memory_topics(self, user_id: str | None = None) -> list[str]:  # public-api
        """Async version of get_all_memory_topics."""
        return self.get_all_memory_topics(user_id)

    # async method
    async def aget_user_memory(  # public-api
        self, memory_id: str, deserialize: bool | None = True, user_id: str | None = None
    ) -> UserMemory | dict[str, Any] | None:
        """Async version of get_user_memory."""
        return self.get_user_memory(memory_id, deserialize, user_id)

    # async method
    async def aget_user_memories(  # public-api
        self,
        user_id: str | None = None,
        agent_id: str | None = None,
        team_id: str | None = None,
    ...
    # async method
    async def aget_user_memory_stats(  # public-api
        self, limit: int | None = None, page: int | None = None, user_id: str | None = None
    ) -> tuple[list[dict[str, Any]], int]:
        """Async version of get_user_memory_stats."""
        return self.get_user_memory_stats(limit, page, user_id)

    # async method
    async def aupsert_user_memory(  # public-api
        self, memory: UserMemory, deserialize: bool | None = True
    ) -> UserMemory | dict[str, Any] | None:
        """Async version of upsert_user_memory."""
        return self.upsert_user_memory(memory, deserialize)

    # async method
    async def aupsert_memories(  # public-api
        self,
        memories: list[UserMemory],
        deserialize: bool | None = True,
        preserve_updated_at: bool = False,
    ) -> list[UserMemory | dict[str, Any]]:
        """Async version of upsert_memories."""
        return self.upsert_memories(memories, deserialize, preserve_updated_at)

    # async method
    async def aclear_memories(self) -> None:  # public-api
        """Async version of clear_memories."""
        self.clear_memories()

    # -- Async Metrics methods --
    # async method
    async def acalculate_metrics(self) -> list[dict[str, Any]] | None:  # public-api
        """Async version of calculate_metrics."""
        return self.calculate_metrics()

    # async method
    async def aget_metrics(  # public-api
        self,
        starting_date: date | None = None,
        ending_date: date | None = None,
    ) -> tuple[list[dict[str, Any]], int | None]:
        """Async version of get_metrics."""
        return self.get_metrics(starting_date, ending_date)

    # -- Async Knowledge methods --
    # async method
    async def adelete_knowledge_content(self, id: str):  # public-api
        """Async version of delete_knowledge_content."""
        self.delete_knowledge_content(id)

    # async method
    async def aget_knowledge_content(self, id: str) -> KnowledgeRow | None:  # public-api
        """Async version of get_knowledge_content."""
        return self.get_knowledge_content(id)

    # async method
    async def aget_knowledge_contents(  # public-api
        self,
        limit: int | None = None,
        page: int | None = None,
        sort_by: str | None = None,
        ...
        """Async version of get_knowledge_contents."""
        return self.get_knowledge_contents(limit, page, sort_by, sort_order)

    # async method
    async def aupsert_knowledge_content(self, knowledge_row: KnowledgeRow):  # public-api
        """Async version of upsert_knowledge_content."""
        return self.upsert_knowledge_content(knowledge_row)

    # -- Async Eval methods --
    # async method
    async def acreate_eval_run(self, eval_run: EvalRunRecord) -> EvalRunRecord | None:  # public-api
        """Async version of create_eval_run."""
        return self.create_eval_run(eval_run)

    # async method
    async def adelete_eval_runs(self, eval_run_ids: list[str]) -> None:  # public-api
        """Async version of delete_eval_runs."""
        self.delete_eval_runs(eval_run_ids)

    # async method
    async def aget_eval_run(  # public-api
        self, eval_run_id: str, deserialize: bool | None = True
    ) -> EvalRunRecord | dict[str, Any] | None:
        """Async version of get_eval_run."""
        return self.get_eval_run(eval_run_id, deserialize)

    # async method
    async def aget_eval_runs(  # public-api
        self,
        limit: int | None = None,
        page: int | None = None,
        sort_by: str | None = None,
        ...
        """Async version of get_eval_runs."""
        return self.get_eval_runs(
            limit=limit,
            page=page,
            sort_by=sort_by,
            sort_order=sort_order,
    ...
    # async method
    async def arename_eval_run(  # public-api
        self, eval_run_id: str, name: str, deserialize: bool | None = True
    ) -> EvalRunRecord | dict[str, Any] | None:
        """Async version of rename_eval_run."""
        return self.rename_eval_run(eval_run_id, name, deserialize)

    # -- Async Culture methods --
    # async method
    async def aclear_cultural_knowledge(self) -> None:  # public-api
        """Async version of clear_cultural_knowledge."""
        self.clear_cultural_knowledge()

    # async method
    async def adelete_cultural_knowledge(self, id: str) -> None:  # public-api
        """Async version of delete_cultural_knowledge."""
        self.delete_cultural_knowledge(id)

    # async method
    async def aget_cultural_knowledge(  # public-api
        self, id: str
    ) -> CulturalKnowledge | None:
        """Async version of get_cultural_knowledge."""
        return self.get_cultural_knowledge(id)

    # async method
    async def aget_all_cultural_knowledge(  # public-api
        self,
        name: str | None = None,
        limit: int | None = None,
        page: int | None = None,
        ...
        """Async version of get_all_cultural_knowledge."""
        return self.get_all_cultural_knowledge(
            name=name,
            limit=limit,
            page=page,
            sort_by=sort_by,
    ...
    # async method
    async def aupsert_cultural_knowledge(  # public-api
        self, cultural_knowledge: CulturalKnowledge
    ) -> CulturalKnowledge | None:
